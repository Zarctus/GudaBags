...
local function CreateDropdownFrame()
    local f = CreateFrame("Frame", "GudaBagsMailCharacterDropdown", UIParent, "BackdropTemplate")
...
local function PopulateDropdown()
    ...
    local viewingCharacter = MailFrame and MailFrame:GetViewingCharacter() or nil
    ...
    for _, char in ipairs(characters) do
        ...
        local hasData = HasMailData(char.fullName)
        if hasData then
